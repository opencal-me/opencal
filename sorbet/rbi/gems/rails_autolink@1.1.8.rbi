...
module ActionView::Helpers::TextHelper
  ...
  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#58
  def concat(string); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#382
  def current_cycle(name = T.unsafe(nil)); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#358
  def cycle(first_value, *values); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#179
  def excerpt(text, phrase, options = T.unsafe(nil)); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#136
  def highlight(text, phrases, options = T.unsafe(nil), &block); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#234
  def pluralize(count, singular, plural_arg = T.unsafe(nil), plural: T.unsafe(nil), locale: T.unsafe(nil)); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#405
  def reset_cycle(name = T.unsafe(nil)); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#62
  def safe_concat(string); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#306
  def simple_format(text, html_options = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#98
  def truncate(text, options = T.unsafe(nil), &block); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#264
  ...
  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#468
  def cut_excerpt_part(part_position, part, separator, options); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#450
  def get_cycle(name); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#455
  def set_cycle(name, cycle_object); end

  # source://actionview/7.0.6/lib/action_view/helpers/text_helper.rb#460
