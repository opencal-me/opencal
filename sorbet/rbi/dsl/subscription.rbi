  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Subscription).void)
      ).returns(T.nilable(T::Enumerator[::Subscription]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Subscription]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Subscription]]))
    end
