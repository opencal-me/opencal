  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Reservation).void)
      ).returns(T.nilable(T::Enumerator[::Reservation]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Reservation]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Reservation]]))
    end
