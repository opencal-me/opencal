...
export type UserKeySpecifier = ('activities' | 'avatarUrl' | 'bio' | 'canEdit' | 'email' | 'firstName' | 'googleEvents' | 'id' | 'initials' | 'isAdmin' | 'isViewer' | 'lastName' | 'name' | 'subscribers' | 'subscribersPendingApproval' | 'url' | UserKeySpecifier)[];
