...
export type ActivityCardActivityFragment = (
  { __typename?: 'Activity' }
  & Pick<Types.Activity, 'descriptionHtml' | 'durationSeconds' | 'end' | 'isOwnedByViewer' | 'joinUrl' | 'name' | 'start' | 'tags' | 'url'>
);
...
export type ActivityJoinPageQuery = (
  ...
  & { activity: Types.Maybe<(
    { __typename?: 'Activity' }
    & Pick<Types.Activity, 'address' | 'addressPlaceName' | 'descriptionHtml' | 'end' | 'id' | 'isOwnedByViewer' | 'joinUrl' | 'name' | 'start' | 'tags' | 'url' | 'openings'>
...
export type ActivityPageQuery = (
  ...
  & { activity: Types.Maybe<(
    { __typename?: 'Activity' }
    & Pick<Types.Activity, 'address' | 'addressPlaceName' | 'descriptionHtml' | 'end' | 'id' | 'joinUrl' | 'name' | 'shareUrl' | 'start' | 'tags' | 'url'>
    & { coordinates: Types.Maybe<(
      { __typename?: 'Coordinates' }
      & Pick<Types.Coordinates, 'latitude' | 'longitude'>
    )>, owner: (
...
export type HomePageQuery = (
  ...
  & { activities: Array<(
    { __typename?: 'Activity' }
    & Pick<Types.Activity, 'id' | 'descriptionHtml' | 'durationSeconds' | 'end' | 'isOwnedByViewer' | 'joinUrl' | 'name' | 'start' | 'tags' | 'url'>
    & { owner: (
      { __typename?: 'User' }
      & Pick<Types.User, 'avatarUrl' | 'firstName' | 'id' | 'initials' | 'url'>
    ) }
    ...
    & { activities: Array<(
      { __typename?: 'Activity' }
      & Pick<Types.Activity, 'id' | 'url' | 'descriptionHtml' | 'durationSeconds' | 'end' | 'isOwnedByViewer' | 'joinUrl' | 'name' | 'start' | 'tags'>
