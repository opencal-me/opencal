...
export type ActivityPageQuery = (
  ...
  & { activity: Types.Maybe<(
    { __typename?: 'Activity' }
    & Pick<Types.Activity, 'address' | 'descriptionHtml' | 'end' | 'id' | 'start' | 'title' | 'url' | 'handle' | 'openings' | 'storyImageUrl'>
...
export type ActivityStoryPageQuery = (
  ...
  & { activity: Types.Maybe<(
    { __typename?: 'Activity' }
    & Pick<Types.Activity, 'id' | 'start' | 'title'>
  )> }
);
...
export type ReservationFooterActivityFragment = (
  { __typename?: 'Activity' }
  & Pick<Types.Activity, 'handle' | 'id' | 'openings' | 'storyImageUrl'>
);
