...
export type ActivityCardActivityFragment = (
  { __typename?: 'Activity' }
  & Pick<Types.Activity, 'descriptionHtml' | 'durationSeconds' | 'end' | 'name' | 'start' | 'tags' | 'url'>
);
...
export type ActivityPageQuery = (
  ...
  & { activity: Types.Maybe<(
    { __typename?: 'Activity' }
    & Pick<Types.Activity, 'address' | 'descriptionHtml' | 'end' | 'id' | 'isOwnedByViewer' | 'name' | 'start' | 'tags' | 'url' | 'openings' | 'storyImageUrl'>
...
export type AddMobileSubscriberMutationVariables = Types.Exact<{
  input: Types.AddMobileSubscriberInput;
}>;


export type AddMobileSubscriberMutation = (
  { __typename?: 'Mutation' }
  & { payload: (
    { __typename?: 'AddMobileSubscriberPayload' }
...
export type HomePageQuery = (
  ...
  & { viewer: Types.Maybe<(
    { __typename?: 'User' }
    & Pick<Types.User, 'id' | 'firstName' | 'isAdmin' | 'url' | 'bio'>
    & { activities: Array<(
      { __typename?: 'Activity' }
...
export type UserPageQuery = (
  ...
  & { user: Types.Maybe<(
    { __typename?: 'User' }
    & Pick<Types.User, 'avatarUrl' | 'bio' | 'canEdit' | 'firstName' | 'id' | 'initials' | 'isViewer' | 'url'>
    & { activities: Array<(
      { __typename?: 'Activity' }
      & Pick<Types.Activity, 'id' | 'url' | 'descriptionHtml' | 'durationSeconds' | 'end' | 'name' | 'start' | 'tags'>
    )> }
...
export const AddMobileSubscriberMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddMobileSubscriberMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AddMobileSubscriberInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"payload"},"name":{"kind":"Name","value":"addMobileSubscriber"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"Field","name":{"kind":"Name","value":"subscriber"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<AddMobileSubscriberMutation, AddMobileSubscriberMutationVariables>;
